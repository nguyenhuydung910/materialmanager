...
public class MaterialController {
    ...
    public ModelAndView listCustomers(@RequestParam("s") Optional<String> s, Pageable pageable){
        ...
        if(s.isPresent()){
            materials = materialService.findAllByNameContaining(s.get(), (org.springframework.data.domain.Pageable) pageable);
        } else {
            materials = materialService.findAll((org.springframework.data.domain.Pageable) pageable);
        }
